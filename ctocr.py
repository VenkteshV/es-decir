...
def extract_pdf(filename):
	...
	cmd = "pytesseract %s >>parsed_image.txt" % (pngfile)
	os.system(cmd)
...
def extract_data():
    cmd1= "grep 'New Loan Number' parsed_image.txt| head -1 >> data.txt"
    cmd2 = "grep 'Coverage %' parsed_image.txt |  head -1 >> data.txt"
    os.system(cmd1)
    os.system(cmd2)
